...
use App\Http\Requests\Panel\Gender\CreateRequest;
use App\Http\Requests\Panel\Gender\UpdateRequest;
use App\Http\Requests\IndexSearchRequest;
use App\Models\Gender;
use App\Services\Panel\GenderService;
...
class GenderController extends Controller
{
     ...
     * search
     *
     * list genders with paginate
     *
     * @bodyParam search string The search value for search genders. Example: search
     * @bodyParam limit int The number of genders in a page, default is 10. Example: 10
    ...
    public function indexSearch(IndexSearchRequest $indexSearchRequest)
    {
        ...
        return $this->genderService->indexSearch($data);
    }
     ...
     * @response 200 {"success":true,"message":"Successfully Created!","data":{"id":1,"name":"male"}}
     ...
     *
     * @bodyParam name string. Example: Male
     * @response 200 {"success":true,"message":"Successfully Updated!","data":{"id":1,"name":"Male"}}
     * @responseFile 404 storage/app/public/messages/notfound.json
     * @response 422 {"success":false,"message":"The name field is required"}
